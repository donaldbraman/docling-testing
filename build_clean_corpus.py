        ...
        if "/K" in elem:
            ...
            for child in children:
                if isinstance(child, int):
                    ...
                    texts.extend(extract_tagged_text_recursive(child_obj, reader, depth + 1, max_depth))
...
def extract_html_texts(soup):
    ...
    for fn in soup.find_all(['div', 'p', 'span'], class_=re.compile(r'footnote|endnote|note', re.I)):
