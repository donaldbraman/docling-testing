#!/usr/bin/env python3
"""
Generate CSV files showing PDF-to-HTML alignment for visual inspection.
...
def find_best_match(
    ...
    """
    Find best matching HTML paragraph for PDF text (exhaustive search).

    Uses RapidFuzz's default_process to normalize both texts (lowercase,
    strip punctuation/whitespace) before matching to handle case differences
