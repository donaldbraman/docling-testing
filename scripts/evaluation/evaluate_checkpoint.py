...
def load_test_data(corpus_path: Path) -> tuple[Dataset, dict]:
    ...
    test_data = {"text": X_test, "label_id": y_test, "label": [ID_TO_LABEL[y] for y in y_test]}
...
def main():
    ...
    parser.add_argument(
        "--corpus", type=str, default="data/clean_7class_corpus.csv", help="Path to corpus CSV file"
    )
