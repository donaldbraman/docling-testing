...
def main():
    ...
    print("\nExpected impact:")
    print("  - body_text recall: 64.6% → 80-90% (reduce false negatives)")
    print("  - body_text precision: 88.4% → 70-80% (accept more false positives)")
    print("  - FP:FN ratio: 1:4.2 → 2:1 (target)")
    ...
    print("\nNext steps:")
    print(
        f"  1. Evaluate: python evaluate_checkpoint.py --checkpoint {output_dir}/checkpoints/checkpoint-100"
    )
    print("  2. Compare to baseline (step 50): body_text recall should be 80-90%")
    print("  3. Check FP:FN ratio in confusion matrix")
    print("  4. If insufficient, try 5x multiplier or threshold adjustment")
