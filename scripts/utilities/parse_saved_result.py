...
def main():
    ...
    doc_pickle_path, extraction_time = save_docling_document(test_pdf, "default", output_dir)
    ...
    print("Parsing time: Instant (no re-extraction)")
    ...
    print(
        f"Removal rate: {100 * (1 - parsed_metrics['body_text_words'] / parsed_metrics['all_text_words']):.1f}%"
    )
