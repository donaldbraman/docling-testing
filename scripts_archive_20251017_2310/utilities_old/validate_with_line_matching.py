#!/usr/bin/env python3
"""Validate corpus using line-level fuzzy matching with RapidFuzz."""
...
def extract_lines_from_pdf(pdf_path: Path) -> list[str]:
    """Extract lines from PDF using training pipeline settings."""
...
def validate_corpus():
    ...
    print("🔍 Validating corpus with line-level fuzzy matching (RapidFuzz)")
