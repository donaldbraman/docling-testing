...
from extract_body_only import extract_body_text, is_likely_citation
...
def main():
    ...
    print(f"These are likely labeled as 'text' or 'paragraph' rather than 'list_item'")
    print(f"\nRecommendation:")
    print(f"  - Expand filtering to check ALL labels for citation patterns")
    print(f"  - Not just 'list_item', but also 'text' and 'paragraph'")
