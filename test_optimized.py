...
def main():
    ...
    print(f"  - Heron-101 model")
    print(f"  - 2x image scaling")
    print(f"  - Single-column fallback enabled")
    print(f"  - Full layout diagnostics")
    print()
    ...
    try:
        ...
        if metrics['total_boxes'] == 0:
            ...
            print(f"   Body/Text: {metrics['label_counts']['body'] + metrics['label_counts']['text']}")
